...
class TaskWrite:
    ...
    due_date_depends_on: Optional[TaskWriteDueDateDependsOn] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('due_date_depends_on') }})
    r"""Will only be accepted if you pass a `contract_id`"""
