...
class DocumentVersionRead:
    ...
    detected_lanugage: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('detected_lanugage'), 'exclude': lambda f: f is None }})
